            ...
            ProductListComponent = (function () {
                ...
                ProductListComponent.prototype.ngOnInit = function () {
                    ...
                    this._productService.getProductswalmart("5426")
                        .subscribe(function (products) { return _this.walmartProducts = products.items; }, function (error) { return _this.errorMessage = error; });
                };
                ProductListComponent.prototype.getProductsCategory = function (category) {
                    var _this = this;
                    this._productService.getProductswalmart(category)
                        .subscribe(function (products) { return _this.walmartProducts = products.items; }, function (error) { return _this.errorMessage = error; });
                };
                ProductListComponent.prototype.onAddCart = function (codigo) {
                    this.getProducto(codigo);
                };
                ProductListComponent.prototype.getProducto = function (codigo) {
